...
class LSTMModel(nn.Module):
    def __init__(self, input_size, hidden_size, output_size, dropout_rate=0.5, lambda_l2=1e-5):
        ...
        self.cnn1 = nn.Sequential(
            ...
            nn.Conv1d(input_size, hidden_size, kernel_size=17, stride=1, padding=8), # 修改: 4 -> 8
            nn.ReLU(),
        ...
        self.cnn2 = nn.Sequential(
            ...
            nn.Conv1d(hidden_size, hidden_size, kernel_size=13, stride=1, padding=6), # 修改: 3 -> 6
            nn.ReLU(),
            nn.MaxPool1d(kernel_size=2, stride=2)
        )
        ...
        self.cnn3 = nn.Sequential(
            nn.BatchNorm1d(hidden_size),
            nn.Conv1d(hidden_size, hidden_size, kernel_size=9, stride=1, padding=4), # 修改: 2 -> 4
            nn.ReLU(),
            nn.MaxPool1d(kernel_size=2, stride=2)
        )
